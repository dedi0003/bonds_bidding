---
title: "Determinant Factors of Indonesia 10-year Sovereign Bonds Yield"
...
Indonesian government regularly issue sovereign bonds in primary market to finance deficit of national budget. In 2021, the issuance target for sovereign bonds is around 95% of total deficit financing. As per 2 September 2021, total outstanding of sovereign bonds is IDR5,810 Trillions or equivalent to USD406 Billions. 

The government sell the sovereign bonds through auction which conducted on Tuesday every two weeks. During 3-hour auction, investors (both individuals and institutions) can put their bidding in multiple prices through Primary Dealers and auction winners will pay their bonds based on their proposed volumes and yields. In addition to the multiple price (competitive) mechanism, the government also offer sovereign bonds to several non-competitive participants such as Indonesia Central Bank (Bank Indonesia) and Indonesia Deposit Insurance Corporation (Lembaga Penjamin Simpanan). This non-competitive buying mechanism may also be conducted by Primary Dealers to complement their competitive bidding purchase. The non-competitive buyers will pay their bonds based on weighted average yield (WAY) from the competitive bidding.

In 2021, there are 20 authorized Primary Dealers comprise of 16 Banks and 4 Securities Companies. This primary dealers system is really important for channeling bonds distributions as well as price discovery. 

They are required to participate in every sovereign bonds auction and to bid for a minimum quantity of the total offering amount. They are allowed to bid both on behalf of their customers and for their own accounts. 

Their competitive bidding also 
Since 2021, yield of 10-year sovereign bonds become one of macroeconomic assumptions in national budget, replacing treasury bills 3-month tenor (Surat Perbendaharaan Negara).
...
Previous researches are mixed on what determining bonds yields. 
This paper provides two new values to existing literature related to the topic. First, it will use exploratory data analysis in the beginning to gain better understanding of each predictor variable. This preliminary step is quite important because different data characteristic, i.e. non-linearity, will need different handling method in confirmatory step/modeling. 
...
ggplot(aes(x = factor(day(date)), y = domestic_10y, color = factor(auction_day), alpha = 0.1))+
  ...
  geom_hline(data = average_2018, aes(yintercept = mean), alpha = 0.5, linetype = "dashed")+
  facet_wrap(~month)+theme_bw()+xlab("Date")+ylab("Yield 10y")
