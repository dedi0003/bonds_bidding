---
title: "Determinant Factors of Indonesia 10-year Local Currency Sovereign Bonds Yield"
...
As primary dealers can participate in competitive bidding in primary market as well as trading in secondary market, they have direct and indirect contribution on forming yield of sovereign bonds.
...
ggplot(aes(x = factor(day(date)), y = domestic_10y, color = factor(auction_day), alpha = 0.1))+
  geom_point(alpha = 1)+scale_x_discrete(breaks = seq(1, 31, 4))+
  geom_hline(data = average_2018, aes(yintercept = mean, linetype = "Monthly Average"), colour= 'black')+
  facet_wrap(~month)+xlab("Date")+ylab("10-y Yield")+
