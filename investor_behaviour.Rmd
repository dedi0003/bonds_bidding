...
US Treasury 10y, Credit Default Swap 5y & 10y, foreign ownership, policy rate (Bank Indonesia 7-day repo rate), exchange rate (Jakarta Interbank Offered Rate/JIBOR), Issuance Mechanism in Primary Market (new policy of greenshoe auction)
- Purpose of study
- Data sources
- Limitation
...
shifting power from foreign to domestic participant (Do central bank/domestic banks become more dominant)?
suplementary auction (greenshoe) reduces yield?
...
As we can see from the plot, in 2015 and 2016 foreign ownership seems to have no strong relationship with the yield. Different situation happened in 2017-2019 where the changes in foreign ownership seems to negatively affect the bonds yield movement. The changes of ownership relatively wider in 2018 compared to 2017 and 2019. 

In 2020, the pattern is quite anomaly in which increase from 0.25-0.33% in foreign ownership seems to raise the yield from 6 up to 8.5%. The yield stumbles afterwards with the increase of foreign ownership up to 40%. 

In January-August 2021, the relationship seems non-linear with no obvious pattern. The ownership drops below 25% but yield decreases further (6-7%).

We may assume that the anomaly in 2020 and 2021 are due to Covid19 pandemic that occured since early 2020. As we aware that the capital excess were absorbed by domestic participants, including Indonesian central bank (Bank Indonesia), thus we will further analyse the pattern of domestic ownership to prove this assumption.
