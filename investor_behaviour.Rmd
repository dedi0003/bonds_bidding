...
US Treasury 10y, Credit Default Swap 5y & 10y, foreign ownership, policy rate (Bank Indonesia 7-day repo rate), exchange rate (Jakarta Interbank Offered Rate/JIBOR)
- Purpose of study
- Data sources
- Limitation
...
3. Key Findings?
i.e.: pandemic effect, 
shifting power from foreign to domestic participant (central bank/domestic banks)?
suplementary auction (greenshoe) effect on yield?
